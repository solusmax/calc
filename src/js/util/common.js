export const getConstantCaseFromKebabCase = (string) => string.toUpperCase().replace(/[-]/g, '_');
...
export const isNumberOk = (number) => !(Number.isNaN(Number(number)) || !isFinite(Number(number)));
